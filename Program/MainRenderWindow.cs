...
namespace Program
{
    ...
    {
        protected readonly List<Object> _mainObjects = new List<Object>();
        protected readonly List<TexturedObject> _mainTexturedObjects = new List<TexturedObject>();
        /// <summary>
        /// 
        /// </summary>
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
           ...
           // Console.WriteLine("camp pos " + _camera.Position);
        ...
        private static float[] LoadObjTextured(string path)
        {
            ...
            foreach (var line in lines)
            {
                lineIndex++;
                var lineSlitted = line.Split(" ");
               // Console.WriteLine(lineIndex + ":" + string.Join(" ", lineSlitted));
                if (lineSlitted[0] == "v")
                {
                    var toAdd = new float[3];
                    toAdd[0] = float.Parse(lineSlitted[1]);
        ...
        public int OpenObj(string obj, Color4 color)
        {
        ...
        /// <summary>
        ///     Rotates an object by a certain amountf
        /// </summary>
        ...
        public void DrawText(string text, float x, float y, Font f, Color4 col, int textAlign = 0b00001000)
        {
            ...
            Console.WriteLine("width " + l.Width + " height " + l.Height);
        ...
        protected class Object
        {
            ...
            public void SetPositionInSpace(Vector3 position)
            {
        ...
        protected class TexturedObject
        {
            private readonly int _mainObject;
            private readonly Shader _shader;
